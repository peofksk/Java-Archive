...
public class GamePlayState implements GameState {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        Lane inputLane = getLaneFromKeyCode(e.getKeyCode());
        if (inputLane != null) {
    ...
    private Lane getLaneFromKeyCode(int keyCode) {
        return switch (keyCode) {
        case KeyEvent.VK_D -> Lane.D;
        case KeyEvent.VK_F -> Lane.F;
        case KeyEvent.VK_J -> Lane.J;
        case KeyEvent.VK_K -> Lane.K;
        default -> null;
        };
    }
