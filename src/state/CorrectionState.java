...
public class CorrectionState implements GameState {
    ...
    public void preload() {
        ...
        nm = new NoteManager(
                context,
                correctionConfig.getMusicBPM(),
                correctionConfig.getMusicOffset()
        );
    ...
    private void renderHud(Graphics2D g) {
        ...
        try {
            ...
            if (!lastJudge.isEmpty() && !"Miss".equals(lastJudge)) {
                drawCenteredString(g2, String.format("%+.1f ms", lastDiffMs), 190, 280);
            }
        } finally {
            g2.dispose();
        }
    ...
    private void renderResult(Graphics2D g) {
        ...
        try {
            ...
            drawCenteredString(g2, "RESULT", 512, 160);
            ...
            drawCenteredString(g2, "Hits: " + hitCount, 512, 240);
            drawCenteredString(g2, String.format("Avg Error (abs): %.2f ms", avgAbs), 512, 290);
